...
**Note**: pseudobulk analysis is a better approach to DEG testing, but this goes beyond the scope of this analysis
(little weight is put into the findings of any DEG analysis in this dataset).

```{r}
#### CELL MARKERS - FIND ALL MARKERS ####
# FindAllMarkers to recapitulate original analysis
# we note that pseudobulk analysis is a better approach to
# DEG testing, but that this goes beyond the scope of the analysis we perform here
