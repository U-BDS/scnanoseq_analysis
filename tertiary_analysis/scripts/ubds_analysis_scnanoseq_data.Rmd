...
This script performs standard post-secondary analysis on the BLAZE data which has been re-processed with our `nf-core/scnanoseq` pipeline. This dataset is compared to the published BLAZE data/matrices which we have analyzed in `ubds_analysis_BLAZE_data.Rmd`.

* Reference information: hg38 GENCODE v40
...
in_files <- dir("./input/scnanoseq_data",full.names = TRUE)
in_files

# sample names
sample_names <- dir("./input/scnanoseq_data",full.names = FALSE)
sample_names <- gsub("\\..*","",sample_names)

# feature
feature_type <- dir("./input/scnanoseq_data",full.names = FALSE)
