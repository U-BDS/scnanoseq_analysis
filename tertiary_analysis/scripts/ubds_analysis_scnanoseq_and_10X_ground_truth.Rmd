...
nFeature_RNA_min <- c(500, 800, 500, 800, 500, 500)
...
cluster_res <- seq(from = 0.1, to = 0.7, by = 0.1)
...
NOTE: in the current analysis only one cell from the 3' dataset did not have an Azimuth annotation (99.97573% of cells were annotated).
All cells from the 5' dataset contained an annotation that was transferred from gene to transcript (100%)
...
cluster_res <- seq(from = 0.1, to = 0.9, by = 0.1)
...
clustree_res <- seq(from = 0, to = 0.9, by = 0.1)
