...
### For UMI-TOOLS DEDUP (default outputs)

nFeature_RNA_min <- c(500, 800, 500, 800, 800, 800, 500, 500)

### For Picard markduplicates dedup (optional in pipeline, more conservative in markding dups)
#nFeature_RNA_min <- c(100, 100, 500, 800, 800, 800, 500, 500)
...
to further label any non-annotated cells based on localization / cell marker expression or input gene-level oarfish data (which is beyond the scope of this validation analysis). 
Most of the cells that did not receive a label, were cells that were dropped in QC steps from isoquant outputs, but retained in oarfish.
