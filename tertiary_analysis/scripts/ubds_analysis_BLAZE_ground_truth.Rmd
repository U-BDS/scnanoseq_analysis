...
This script performs standard post-secondary analysis on the BLAZE data which has been published. This dataset serves as ground-truth,
and analyzed data will be compared to the `nf-core/scnanoseq` analysis of the raw BLAZE FASTQs as a critical validation step from the pipeline. 
